  ...
  return (
    <>
      <div className="sticky top-0 z-40 border-b border-[#E6D6B9] bg-[#FFF9EF]/95 px-3 py-2 backdrop-blur lg:hidden">
        <nav
          className="-mx-3 flex items-center gap-2 overflow-x-auto px-3 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          aria-label="Sali"
        >
          {halls.map((hall) => {
            ...
            return (
              <Link
                className={classNames(
                  "flex min-h-11 shrink-0 items-center whitespace-nowrap rounded-lg px-4 text-sm font-semibold transition",
                  active
